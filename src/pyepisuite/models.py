...
class SewageModelComponents:
    ...
    CalculationVariables: Optional[List[Optional[float]]]
...
class FugacityModelComponents:
    ...
    aEmissionArray: Optional[List[Optional[float]]]
    aAdvectionTimeArray: Optional[List[Optional[float]]]
    aFugacities: Optional[List[Optional[float]]]
    aReaction: Optional[List[Optional[float]]]
    aAdvection: Optional[List[Optional[float]]]
    aReactionPercent: Optional[List[Optional[float]]]
    aAdvectionPercent: Optional[List[Optional[float]]]
    aSums: Optional[List[Optional[float]]]
    aTimes: Optional[List[Optional[float]]]
    HalfLifeArray: Optional[List[Optional[float]]]
    HalfLifeFactorArray: Optional[List[Optional[float]]]
    Emission: Optional[List[Optional[float]]]
    AdvectionTimesArray: Optional[List[Optional[float]]]
